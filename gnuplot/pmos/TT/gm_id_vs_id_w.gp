...
plot \
    ...
    "pmos_l0p5_tt.dat"  using 4:5 with lines lw 2 lc rgb "#d29922" title "L = 0.30 µm", \
    "pmos_l0p7_tt.dat"  using 4:5 with lines lw 2 lc rgb "#bc8cff" title "L = 0.60 µm", \
    "pmos_l1p0_tt.dat"  using 4:5 with lines lw 2 lc rgb "#ff7b72" title "L = 1.00 µm"
