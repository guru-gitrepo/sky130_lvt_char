...
N 1850 -380 1890 -380 {lab=#net2}
N 1890 -430 1890 -380 {lab=#net2}
N 1850 -430 1890 -430 {lab=#net2}
N 1850 -350 1850 -320 {lab=#net3}
C {title.sym} 1440 -200 0 0 {name=l1 author="Guruprasad"}
C {vsource.sym} 1680 -320 0 0 {name=V1 value=0.9 savecurrent=false}
C {vsource.sym} 2000 -420 0 0 {name=V2 value=1.8 savecurrent=false}
...
*.include gm_id_ff.sp
"}
C {sky130_fd_pr/pfet_01v8_lvt.sym} 1830 -380 0 0 {name=M1
W=1
L=\{length\}
nf=1
mult=1
...
C {vsource.sym} 1850 -290 0 0 {name=V3 value=0.9 savecurrent=false}
