## gm over Id technique
  ...
  7. Repeat the same for other values of L and also for slow and fast corners.
    Finally, you will have above plots for the following conditions

  |L ($\mu m$)  | TT @27C   | SS @80C   | FF @0C|
  |:-------:|:---------:|:---------:|:---------:|
  |0.15     |   [X]     |   [X]     |   [X]     |
  |0.30     |   [X]     |   [X]     |   [X]     |
  |0.60     |   [X]     |   [X]     |   [X]     |
  ...
  8. Next, characterize PMOS in the similar manner.
